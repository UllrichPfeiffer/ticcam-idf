...
#define LV_SYMBOL_SQUAREWAVE    "\xef\xa0\xbe" // 63550 F83E
#endif
#if !defined LV_SYMBOL_BEAT
#define LV_SYMBOL_BEAT          "\xef\x93\xb0" // 62704 F4F0
#endif
#if !defined LV_SYMBOL_ZERO
#define LV_SYMBOL_ZERO          "\xef\x93\xb3" // 62707 F4F3
#endif
#if !defined LV_SYMBOL_SLIDER
#define LV_SYMBOL_SLIDER        "\xef\x87\x9e" // 61918 F1DE
#endif
#if !defined LV_SYMBOL_CALCULATOR
#define LV_SYMBOL_CALCULATOR    "\xef\x87\xac" // 61932 F1EC
#endif
#if !defined LV_SYMBOL_EXPAND
#define LV_SYMBOL_EXPAND        "\xef\x81\xa5" // 61541 F065
#endif
#if !defined LV_SYMBOL_ICE
#define LV_SYMBOL_ICE           "\xef\x8b\x9c" // 62172  F2DC
#endif
...
#define LV_SYMBOL_THERMO1       "\xef\x8b\x8b" // 62155 F2CB
#endif
#if !defined LV_SYMBOL_CHIP
#define LV_SYMBOL_CHIP       "\xef\x8b\x9b" // 62171 6F2DB
#endif
#if !defined LV_SYMBOL_CHART
#define LV_SYMBOL_CHART       "\xef\x88\x81" // 61953 F201
#endif
#if !defined LV_SYMBOL_LINEDOWN
#define LV_SYMBOL_LINEDOWN "\xee\x92\xb8" // 58552 E4B8
#endif
#if !defined LV_SYMBOL_LINEUP
#define LV_SYMBOL_LINEUP "\xee\x93\x82" // 58562 E4C2
#endif
#if !defined LV_SYMBOL_ARRAY
#define LV_SYMBOL_ARRAY  "\xef\x80\x8a" // 61450 F00A
#endif
#if !defined LV_SYMBOL_BULBOFF
#define LV_SYMBOL_BULBOFF "\xef\xa0\x8b" // 63499 F80B
#endif
#if !defined LV_SYMBOL_BULBON
#define LV_SYMBOL_BULBON  "\xef\xa0\x8c" // 63500 F80C
#endif
#if !defined LV_SYMBOL_HISTO
#define LV_SYMBOL_HISTO  "\xef\x9a\x81" // 63105 F681
#endif
...
enum {
    ...
    _LV_STR_SYMBOL_SQUAREWAVE,
    _LV_STR_SYMBOL_BEAT,
    _LV_STR_SYMBOL_ZERO,
    _LV_STR_SYMBOL_SLIDER,
    _LV_STR_SYMBOL_CALCULATOR,
    _LV_STR_SYMBOL_EXPAND,
    _LV_STR_SYMBOL_ICE,
    _LV_STR_SYMBOL_THERMO5,
    _LV_STR_SYMBOL_THERMO4,
    _LV_STR_SYMBOL_THERMO3,
    _LV_STR_SYMBOL_THERMO2,
    _LV_STR_SYMBOL_THERMO1,
    _LV_STR_SYMBOL_CHIP,
    _LV_STR_SYMBOL_CHART,
    _LV_STR_SYMBOL_LINEDOWN,
    _LV_STR_SYMBOL_LINEUP,
    _LV_STR_SYMBOL_ARRAY,
    _LV_STR_SYMBOL_BULBOFF,
    _LV_STR_SYMBOL_BULBON,
    _LV_STR_SYMBOL_HISTO,
};

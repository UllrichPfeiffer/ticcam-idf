...
<html>
    <head>
        ...
        <title>TicWave Camera TicCam-3kpix</title>
        <style>
            body {
...
<label for="nav-toggle-win" class="toggle-section-label">&#9776;&nbsp;&nbsp;Window</label><input type="checkbox" id="nav-toggle-win" class="hidden toggle-section-button" checked="checked">
                        <section class="toggle-section">
                            ...
                            <div class="input-group">
                                <label for="my_framesize">Sensor Resolution</label><select id="my_framesize">
                                    <option value="2">Reg (33x33)</option>
                                    <option value="1">Box (48x48)</option>
                                    <option value="0" selected="selected">Full (64x48)</option>
                                </select>
                            </div>

                            <div class="input-group" id="set-col-res-group">
                                <label for="col">Horizontal</label>
                                <div class="text">
                                    X:<input id="col-start" type="text" minlength="1" maxlength="2" size="4" value="0">
                                </div>
                                <div class="text">
                                    Y:<input id="col-end" type="text" minlength="1" maxlength="2" size="4" value="63">
                                </div>
                            </div>
                            <div class="input-group" id="set-total-res-group">
                                <label for="row">Vertical</label>
                                <div class="text">
                                    X:<input id="row-start" type="text" minlength="1" maxlength="2" size="4" value="0">
                                </div>
                                <div class="text">
                                    Y:<input id="row-end" type="text" minlength="1" maxlength="2" size="4" value="47">
                                </div>
                            </div>
...
const setResButton = document.getElementById('set-resolution')
  setResButton.onclick = () => {
    let res = parseInt(document.getElementById('my_framesize').value);
    let col_start = parseInt(document.getElementById('col-start').value);
    let row_start = parseInt(document.getElementById('row-start').value);
    let col_end = parseInt(document.getElementById('col-end').value);
    let row_end = parseInt(document.getElementById('row-end').value);

    setWindow(col_start, row_start, col_end, row_end, 0, 0, 0, 0, 0, 0, false, false, function(code, txt){
      if(code != 200){

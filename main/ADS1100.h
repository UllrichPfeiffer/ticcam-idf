...
/**************************************************************************
    I2C ADDRESS/BITS
**************************************************************************/
    #define ADS1100_DEFAULT_ADDRESS         (0x48)    // AD0: 1001 000 (ADDR = GND) 
    #define ADS1100_AD6_ADDRESS         (0x4E)    // AD6: 1001 000 (ADDR = GND)
...
class ADS1100
{
    ...
    public:
        ...
        void setWireInterface(TwoWire* wire);
        uint8_t i2cread(void);
        void i2cwrite(uint8_t x);
        void writeRegister(uint8_t i2cAddress, uint8_t value);
        uint16_t readRegister(uint8_t i2cAddress);
        uint16_t Measure_Singleended();
